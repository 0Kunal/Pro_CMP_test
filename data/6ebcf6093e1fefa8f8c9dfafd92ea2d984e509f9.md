...
Locator: locator('[id="gravitoPROCMP-tab-container-id"]')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('[id="gravitoPROCMP-tab-container-id"]')

    at /home/runner/work/Pro_CMP_test/Pro_CMP_test/tests/consent-banner.spec.js:11:26
```
...
- banner:
  ...
  - text: for more information. 2026-07-19 05:26:43 UTC
- text: You
